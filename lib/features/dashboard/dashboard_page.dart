...
class _DashboardPageState extends State<DashboardPage> {
  ...
  final List<Widget> _pages = [
    const Center(child: Text("Welcome to Kavarera POS", style: TextStyle(fontSize: 24))),
    const SupplierPage(),
    const CategoryPage(),
    const ProductPage(),
    const CustomerPage(),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                const Icon(Icons.point_of_sale_rounded, size: 48, color: AppColors.white),
  ...
  Widget _buildMenuItem(int index, IconData icon, String title) {
    ...
    return Container(
      ...
      child: ListTile(
        leading: Icon(icon, color: isSelected ? AppColors.white : AppColors.white.withOpacity(0.7)),
        title: Text(
          title,
          style: TextStyle(
